...
<a href="https://www.youtube.com/channel/UCMdDWRogZKZwEo26Jqmkc9Q" target="_blank"
...
<a href="https://dev.to/arrefl" target="_blank" class="flex bg-black items-center justify-center">
  <img src="./resource/img/devto.svg" alt="data" style="border-radius: 19.9%" class="w-10 h-10 bg-white" />
</a>

<div class="flex bg-black items-center justify-center w-10 h-10">
  <div id="dark-mode-toggle" class="cursor-pointer">
    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 stroke-white hidden dark:block" fill="none"
      viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      <path stroke-linecap="round" stroke-linejoin="round"
        d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
    </svg>
    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 stroke-[#0A1122] block dark:hidden" fill="none"
      viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      <path stroke-linecap="round" stroke-linejoin="round"
